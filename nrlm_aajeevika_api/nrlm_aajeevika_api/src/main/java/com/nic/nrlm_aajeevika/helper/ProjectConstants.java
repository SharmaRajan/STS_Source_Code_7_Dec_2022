package com.nic.nrlm_aajeevika.helper;

public class ProjectConstants {
	public static final String AUTHORIZATION_HDR = "Authorization";
	public static final String IS_AUTHORIZE_URL = "N";
	public static final String 	UPLOADDIR = "images/";
	public static final String 	FILE_URL_PREFIX = "https://stgaajeevikaimg.dhwaniris.in/";
	...
	public static final Integer CONTENT_TYPE = 1; // for file type
