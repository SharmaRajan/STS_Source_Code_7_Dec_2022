...
public class AuthenticationController {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponseDto> login(@RequestBody LoginRequest lr) throws Exception {
        requestContext.setRequestBody(lr);
        Authentication auth = null;
        auth = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(lr.getLoginId(), lr.getPassword()));
        ...
        authService.updateUserDetail(lr.getLoginId(), jwt);
