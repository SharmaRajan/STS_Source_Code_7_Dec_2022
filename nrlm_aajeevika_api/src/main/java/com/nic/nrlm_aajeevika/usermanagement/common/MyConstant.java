...
public class MyConstant {
    ...
    public static final String FEEDBACK_URL = "/aajeevika/feedback/save";
    ...
    public static final String CAPTCHA_URL = "/nrlm/captcha/get";
    public static final int PENDING = 0;

    public static final String NOCAPTCHA = "yes";
