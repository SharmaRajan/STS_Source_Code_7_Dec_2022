...
import com.nic.nrlm_aajeevika.usermanagement.repository.LoginHistoryRepository;
...
//		return 0;
	...
	public void saveloginhistory(HttpServletRequest request,String loginid,int flag) {
		...
		if(flag==1) {
			loginHistory.setLoggedInAt(new Date());
		}
		else {
			loginHistory.setLoggedOutAt(new Date());
		}
