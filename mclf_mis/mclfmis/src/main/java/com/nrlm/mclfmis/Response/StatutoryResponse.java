...
public class StatutoryResponse {
    ...
    private List<StatutoryLicenseResponse> licenseList;
   // private Integer statusValue;
    
    
    public StatutoryResponse(Long id, String stateCode, String stateName, String districtCode, String districtName,
			...
			Integer finPerformRating, Integer mgmtRating, Integer overallRating, String status,String finYear) {
		super();
		this.id = id;
...
//	}
	...
	public List<StatutoryLicenseResponse> getLicenseList() {
		return licenseList;
	}


	public void setLicenseList(List<StatutoryLicenseResponse> licenseList) {
